package com.ojaq.muslimgo.core.data.local
    ...
    fun getKnownLastLocation(): LiveData<List<String>> {
        ...
        fusedLocation.lastLocation.addOnSuccessListener { location ->
            if (location != null) {
                ...
                Toast.makeText(context, "Someting wrong happeneed.", Toast.LENGTH_SHORT).show()
                Log.e("LocPref", "error get location: $location")
            }
        }

        fusedLocation.lastLocation.addOnFailureListener {
            Log.e("LocPref", "getKnownLastLocation: " + it.localizedMessage)
        }
